...
from sippers.models.cnmc_v3 import CnmcV3SipsSchema, CnmcV3MeasuresSchema
from marshmallow import pre_load, fields


class CnmcV3SipsAdapter(SipsAdapter, CnmcV3SipsSchema):
...
class CnmcV3MeasuresAdapter(MeasuresAdapter, CnmcV3MeasuresSchema):
