...
TABLA_12 = ['BD', 'PY', 'BC', 'BL', 'BO', 'CI', 'EN', 'FI', 'UR', 'GR', 'CN', 'PR', 'LG', 'PQ', 'CM', 'PT', 'RS', 'PZ', 'CL', 'TR', 'PB', 'PA', 'DI', 'RA', 'PD', 'PE', 'PJ', 'PI', 'NU', 'PL', 'CJ', 'AC', 'CH', 'CO', 'AD', 'AG', 'AF', 'ZN', 'ED', 'CA', 'AL', 'CF', 'AR', 'AU', 'AV', 'CS', 'CR', 'GL', 'VI', 'CT', 'MA', 'SU', 'PO', 'MU', 'FC', 'PS', 'RD', 'OV', 'SD', 'MZ']
